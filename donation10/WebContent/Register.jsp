...
/*css for full size background image http://p1.pichost.me/i/66/1910857.jpg*/
  background: url('images1/111.jpg') no-repeat center center fixed; 
...
body {
    background: url('images1/111.jpg');
    text-align: right;
    padding-top: 40px;
    padding-left: 20px;
}
...
<div class="container">
    	...
    	<form role="form" class="form-inline col-md-9 go-right" style="color: Green;background-color:#FAFAFF;border-radius:0px 100px 100px 22px;margin-left:600px " action="RegisterServlet" method="POST" >
			<center><h2>REGISTER</h2>
            <p>please fill the details to register</p></center>  
            <br>
             <p>firstName:</p> 
    ...
    <select  required id="bloodGroup" name="bloodGroup" class="form-control">
      ...
      <option value="onegative">O-</option>
       ...
       <div class="form-group">            
		...
		<br><br> <p>phone:</p>
		<div class="form-group">
			<input  name="phoneNumber" id="phone" type="tel"  pattern="[0-9]{10}"  class="form-control" required>
			<label for="phoneNumber">Phone no: <span class="glyphicon glyphicon-phone"></span></label>
		</div>
        <br><br>
        <p>Email</p>
         <div class="form-group">
    		<input name="email" type="email" class="form-control" style="width:400px;"required>
