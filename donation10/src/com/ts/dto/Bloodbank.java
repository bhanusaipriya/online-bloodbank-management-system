...
public class Bloodbank {
	...
	public Bloodbank(int bloodbankId, String name, String location, int apositive, int anegative, int bpositive,
			int bnegative, int abpositive, int abnegative, int opositive, int onegative, String phone,String address,String password) {
		super();
		this.password = password;
		this.bloodbankId = bloodbankId;
		this.name = name;
	...
	public Bloodbank(String name, String location, int apositive, int anegative, int bpositive, int bnegative,
			int abpositive, int abnegative, int opositive, int onegative, String phone,String address,String password) {
		super();
		this.password = password;
		this.name = name;
		this.location = location;
