...
public class AddbloodbankServlet extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Bloodbank bloodbank = new Bloodbank(name,location,quantityofApos,quantityofAneg,quantityofBpos,quantityofBneg,quantityofABpos,quantityofABneg,quantityofOpos,quantityofOneg,phone,address,password);		
