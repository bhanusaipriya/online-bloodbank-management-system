 ...
 <table class="table table-hover">
		...
		<tr>			
		    ...
		    <% List <Donor_Bloodbank> rb= d.getDonorbloodbank();
		       ...
		       <tr>
		    	   <td style="padding-right:20px;font-size:17px"><%=r1.getBloodbank().getBloodbankId() %></td>
		    	   <td style="padding-right:20px;font-size:17px"><%=r1.getBloodbank().getName() %></td>
		    	   <td style="padding-right:20px;font-size:17px"><%=r1.getBloodbank().getLocation() %></td>
		    	   <td style="padding-right:20px;font-size:17px"><%=r1.getBloodbank().getAddress() %></td>
		    	   <br/>
		    </td>
             <% } %>
             </table>
