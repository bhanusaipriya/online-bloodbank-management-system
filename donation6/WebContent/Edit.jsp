               ...
               <form  action="UpdateServlet" method="post" >
                 ...
                 <tbody>
                  ...
                  <td> email : </td><td>  <br><input type="text" name="email" value="${donor.email}"><br/><br/></td>
                    ...
                    <tr>
                  <td> Address : </td><td>  <br><input type="text" name="address" value="${donor.address}"><br/><br/> </td>
                   </tr>
                    <tr>
                  <td> userName : </td><td>  <br><input type="text" name="userName" value="${donor.userName}"><br/><br/></td>
                   </tr>
                     <tr>
                  <td>Password :</td><td>  <br><input type="password" name="password" value="${donor.password}"><br/><br/></td>
                   </tr>
                   </tbody>
                   </table>
