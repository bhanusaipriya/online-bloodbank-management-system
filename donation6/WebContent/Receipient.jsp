		...
		<div class="row main">
			...
			<div class="main-login main-center">
				<form class="form-horizontal" method="post" action="ReceipientRegistration">
					...
					<div class="form-group">
						...
						<div class="cols-sm-10">
							<div class="input-group">
								...
								<input type="text" class="form-control" name="location" id="city"  placeholder="Enter the City "/>
							</div>
					...
					<div class="form-group">
						<label for="adderss" class="cols-sm-2 control-label">Password</label>
						<div class="cols-sm-10">
							<div class="input-group">
								<span class="input-group-addon"><i class="fa fa-map-marker fa-lg"></i></span>
								<input type="password" class="form-control" name="password" id="city"  placeholder="password "/>
							</div>
							<div class="message" id="message_address">
							</div>
						</div>
