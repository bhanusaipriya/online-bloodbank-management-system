...
<body>
    ...
    <div class="main-container">
        ...
        <aside class="hit_sidebar open_sidbar sidebar-slide-push">
            ...
            <span class="remove_text"> View all Requests</span></a></li>
            ...
            <li class="nav-item dropdown dmenu">
             <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown"><span class="nav-icon"><i class="glyphicon glyphicon-plus" aria-hidden="true"></i></span>
              <span class="remove_text">Add</span>
            </a>
            <div class="dropdown-menu sm-menu" color=red >
              <a class="dropdown-item" href="Bloodbankregister.jsp">Add Blood Bank</a></a>
              <a class="dropdown-item" href="DonorRegisterByAdmin.jsp">Add Donor</a>
            </div>
          </li>            
                <li><a href="MessagesServlet">
                <span class="nav-icon"><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i></span>
            <span class="remove_text">Messages</span> </a></li>
